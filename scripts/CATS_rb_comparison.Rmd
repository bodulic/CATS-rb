...
#Structural inconsistency analysis - transcript segments mapping to different genomic regions
...
#Writing transcripts whose segments map to different genomic regions to file
write.table(str_inc_gen_pos_tr, file = "transcripts_diff_genomic_region.tsv", sep = "\t", row.names = F, col.names = T, quote = F)
